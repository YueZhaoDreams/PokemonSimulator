...
3. **Ask Cursor** — tap the Combo Cub mark (bottom-right). Chat opens as a split agent panel (right on desktop, top on a phone). Talk/mic and spoken replies stay in that panel. The agent can run simulations, pytest, and lab scripts, and it can edit the app when you ask.
