...
STRATEGY_LIBRARY = {
    ...
    "party": StrategySpec(
        ...
        description=(
            ...
            "when Dragapult is Active — 200 plus 6 bench counters even if that is not a KO — then "
            "Photon finishes the 120 leftover. Do not evolve CLC onto Budew (Itchy Pollen). "
            "Wondrous Moon 170 when it takes prizes this turn (two hits KO "
