...
STRATEGY_LIBRARY = {
    ...
    "party": StrategySpec(
        ...
        description=(
            ...
            "Trainer order: hunt Maximum Belt (Arven before Tool Box), dump playable "
            "items, then Lillie (until 6, or 8 on your first turn) or Hop so drawn "
            "evolves can still come down this turn. "
