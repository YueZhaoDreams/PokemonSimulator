...
STRATEGY_LIBRARY = {
    ...
    "party": StrategySpec(
        ...
        description=(
            ...
            "Photon the copy that can pay. Vs D bench the second Mewtwo only after "
            "the first is at 90 HP, then rotate onto it. Playing both at full HP "
            "from hand is a 47% line (fuel split + extra 2-prize KO). "
