...
STRATEGY_LIBRARY = {
    ...
    "party": StrategySpec(
        ...
        description=(
            ...
            "engines into deck-out). Vs D: 3 Clefairy Party (Active + bench), bank 2 Psychic "
            "on the Active Clefairy as discard fuel, Prankish a benched engine if it delays "
            "Demolish. After the 1-prize KO, Transfer-support Mewtwo attaches 1 and "
            "Transfer Charge 2 onto the Belted attacker. Evolve Clefable ex on a "
            "benched Party-fueled Clefairy so Lunar Zone makes the support's Retreat 0 "
            "(it only has the 1 Psychic that paid Transfer). Then the attacker comes "
            "Active for Photon. "
