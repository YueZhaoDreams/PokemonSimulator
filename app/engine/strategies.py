...
STRATEGY_LIBRARY = {
    ...
    "party": StrategySpec(
        ...
        description=(
            ...
            "engines into deck-out). Vs D going-first and going-second scripts, else the Mega wall: "
            "(1) 4 Clefairy + 1 Mewtwo + Belt — Party onto the bench, load [P][P]+Belt on Mewtwo, "
            "sacrifice empty Active Clefairy (1 prize). Going first: one chump then Photon. "
            "Going second: two chumps while Party keeps firing, then Photon. "
            "(2) 3 Clefairy + 2 Mewtwo + Belt + Clefable ex Lunar Zone — support Transfer Charge "
            "2 from discard, free-retreat onto the Belted closer, Photon. Going first also uses "
            "a Clefable/ex Charge fodder. "
            "(3) Going first 2 Clefairy + 2 Mewtwo + Prankish + Clefable ex, only when no more "
            "Clefairy can come down: Party, evolve Prankish to bounce T2 Fighting (Demolish "
            "slips to T6), empty Clefable is the 1-prize KO, support Charge +2 then tanks one "
            "140, then Zone and swap to the full-HP Belted closer for the 2-prize Photon. "
            "(4) Going first 2 Clefairy + 1 Mewtwo + Mega + Clefable ex + Belt, same gate: "
            ...
            "(5) Going second 3 Clefairy + 1 Mewtwo + Mega + Clefable ex + Belt, only when no "
            "fourth Clefairy can come down: T2 Party +3, T3 one empty Clefairy chump, T4 Party "
            "+2 and Mega (soaks T5 and T7), T8 evolve Lunar Zone and switch onto the ex, "
            ...
            "already the second tank. Rebel Clash Clefable Prankish bounces an Energy off the "
            "opponent's Active on evolve (Fighting to slip Demolish; Fire/Psychic can delay Dive). "
            "If a Metronome Clefable is in the list (CLC 014 [C] or TWM [CC]), copy the "
            ...
            "Penny then returns that Basic and every attached card, including Telepathic. "
            "A benched Clefairy promotes and uses Party. The replay is full HP because damage "
            "counters are removed when a Pokémon leaves play. "
            "Double Prankish: Party, evolve Rebel Clash Clefable, return it with Mr. Briney's "
            "Compassion (attachments to hand; not Pokémon-ex), Professor Turo's Scenario "
            "(any Pokémon, discard attachments), or Seeker after a Switch (each player returns "
            "one Bench Pokémon, you first). Promote a Clefairy that was already in play, Party, "
            "and evolve that same Clefable onto it. A Basic put down this turn cannot evolve. "
            "When the opponent has exactly one Benched Pokémon and the Active attack KOs "
            "their Active, play Seeker first: they return that Bench Pokémon, then the KO "
            "leaves no Pokémon in play. If you have a Bench, you return one too, and the "
            "script keeps the Bench Pokémon whose Energy the KO still needs. "
            "Cheren's Care is Colorless only and does not pick up this line. AZ matches Turo. "
            ...
            "Lillie (until 6, or 8 on your first turn) before Energy Search / Nest. "
            "Boss's Orders to take the last prize(s), or to put Dragapult Active so Metronome "
            "can copy Dive. "
    ...
    "g": StrategySpec(
        ...
        description=(
            ...
            "Mega, Munkidori, or a Basic Energy. Poké Pad and Ultra Ball are held "
            "until the deck is missing a piece: Clefairy while fewer than three "
            "are in hand or play, Prankish when two Clefairy are out and the "
            "opponent's Active has an Energy, then Ledyba, Ledian, or Munkidori. "
            "Once a Clefairy is owned, Ultra Ball takes Clefable ex while Lunar Zone "
            "is missing, ahead of another Clefairy. Mega only after that ex is in play. "
            "Pad cannot take either. "
            "One Rebel Clash Prankish evolves "
