...
STRATEGY_LIBRARY = {
    ...
    "g": StrategySpec(
        ...
        description=(
            ...
            "Mega, Munkidori, or a Basic Energy. Poké Pad and Ultra Ball fetch "
            "the hole: Clefairy while fewer than two are in hand or play, "
            "Prankish Clefable when the opponent's Active has an Energy to "
            "bounce, otherwise the missing Ledyba / Ledian / Munkidori / bird. "
            "Ultra Ball may also take Clefable ex or Mega; Pad cannot, they "
            "have a Rule Box. One Rebel Clash Prankish evolves onto a bench "
            "Clefairy only when that Energy is there; the Active Clefairy stays Party. "
            "If Telepathic Psychic Energy is in hand, attach it to a Psychic Pokémon before "
