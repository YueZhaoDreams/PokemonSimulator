...
STRATEGY_LIBRARY = {
    ...
    "party": StrategySpec(
        ...
        description=(
            ...
            "If a Metronome Clefable is in the 2-of slot (CLC 014 [C] or TWM [CC]), copy the "
            "opponent's attack we choose — not Mime Jr. Mimed Games (they choose). Vs Dragapult: "
            "Boss the ex Active, evolve, then Metronome copies Phantom Dive 200 + 6 "
            "bench counters. Do not evolve Metronome as a Prankish sponge. "
