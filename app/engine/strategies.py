...
STRATEGY_LIBRARY = {
    ...
    "party": StrategySpec(
        ...
        description=(
            ...
            "engines into deck-out). Vs D two going-first scripts, else the Mega wall: "
            "(1) 4 Clefairy + 1 Mewtwo — Party onto the bench, load [P][P]+Belt on Mewtwo, "
            "sacrifice the empty Active Clefairy (1 prize), Photon on turn 3. "
            "(2) 3 Clefairy + 2 Mewtwo + Belt + any Clefable or Clefable ex as Charge fodder "
            "+ Clefable ex Lunar Zone — Transfer then Photon on turn 4. "
