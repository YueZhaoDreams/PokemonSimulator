...
STRATEGY_LIBRARY = {
    ...
    "party": StrategySpec(
        ...
        description=(
            ...
            "engines into deck-out). Vs D two scripts: (1) 4 Clefairy + 1 Mewtwo — Party, "
            "load [P][P]+Belt on Mewtwo, T2 evolve Active Clefairy into Clefable ex to soak "
            "one Demolish, T3 attach 1 to the ex (Lunar Zone) and free-retreat into Photon. "
            "(2) 3 Clefairy + 2 Mewtwo — Active Clefairy as 1-prize discard battery, "
            "Transfer-support Mewtwo, benched Lunar Zone, Belted Photon. "
