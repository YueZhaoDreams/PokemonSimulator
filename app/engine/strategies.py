...
STRATEGY_LIBRARY = {
    ...
    "g": StrategySpec(
        ...
        description=(
            ...
            "Mega, Munkidori, or a Basic Energy. Poké Pad is held until the deck "
            "is missing a piece: Clefairy while fewer than three are in hand or "
            "play, Prankish when two Clefairy are out and the opponent's Active "
            "has an Energy, then Ledyba, Ledian, or Munkidori. Pad cannot take "
            "Clefable ex or Mega. Ultra Ball needs 2 other cards to discard and "
            "pays with a spare Basic Energy before Boss's Orders or a bench Ball. "
