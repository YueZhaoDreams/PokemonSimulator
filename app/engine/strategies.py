...
STRATEGY_LIBRARY = {
    ...
    "party": StrategySpec(
        ...
        description=(
            ...
            "Poké Pad (if in the list) searches a Pokémon without a Rule Box: Clefairy or "
            "Prankish Clefable on demand, never Clefable ex / Mega / Mewtwo. Play it when the "
            "Party engine is short or the Prankish evo is missing from play and hand. "
            ...
            "Boss's Orders only to take the last prize(s). "
