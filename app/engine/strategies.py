...
STRATEGY_LIBRARY = {
    ...
    "party": StrategySpec(
        ...
        description=(
            ...
            "Vs Dragapult: Party once, evolve Clefable ex on a fueled bench Clefairy for Wondrous "
            "Moon 170 (two hits KO 320 HP Dragapult, 2 prizes), Mega on another Clefairy as a 320 HP "
            "Dive wall. End on Mega or Mewtwo that still survives 200 — never 60 HP Clefairy, and "
            "never a leftover 60 HP ex. Photon / a Basic finishes the last prize. "
