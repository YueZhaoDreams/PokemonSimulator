...
STRATEGY_LIBRARY = {
    ...
    "party": StrategySpec(
        ...
        description=(
            ...
            "front; never KO Mewtwo if Mega/ex or another Mewtwo still survives 140. "
            "Photon the copy that can pay. Keep one Mewtwo in play: benching the "
            "second while the first is still up (full HP or 90 HP) is a 47% C vs D "
            "line. After a KO the spare comes down as the next closer. "
