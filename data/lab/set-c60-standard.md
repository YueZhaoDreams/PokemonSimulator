...
- Do not put CLC Metronome back in this 2-of slot unless the plan is specifically to copy Dive on a 70 HP body. 2026-09-22 1-of trial (seed `20260922`): party now Bosses Dragapult and copies Dive (CLC 649 / TWM 457 copies in 3,000 T60 games), and T60 still drops 67.2 → 65.5 / 66.0. The lock stays 2 Prankish. See [set-c60-metronome.md](set-c60-metronome.md).
