...
- Do not lock 1 Prankish Clefable → Poké Pad yet. Same seed, Battle Cage C60: D60 +1.5 and wComp 68.5 → 69.3, but Hedrick going first 67.9 → 65.4 and T60 is noise (see [set-c60-poke-pad.md](set-c60-poke-pad.md)).
