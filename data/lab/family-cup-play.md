...
2026-08-22: whole-photo captioning invented a Paldea Evolved Starly line on A and a Surging Sparks Walrein line on B. Those names are not in `data/gallery` and do not gallery-match `data/samples/set-a.jpg` / `set-b.jpg`. Lists stay on the gallery-matched 30-card carpet (A: Dondozo / Clefairy / ghosts / Orthworm; B: two Pikachu prints / fire line / Spinarak). Re-ID must crop then match, not guess evolution lines from a layout photo.
