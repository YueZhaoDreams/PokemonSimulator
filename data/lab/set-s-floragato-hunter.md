...
- Open on Mewtwo when it is in the opening 7. Nest it if it is still in the deck.
- One Sprigatito in play to evolve; extras and Tangela pay [G][C].
- Hold Maximum Belt in hand until Floragato is in play. Never park it on Mewtwo.
- Stay on Mewtwo until Floragato can OHKO this turn, then Switch in.
- Do not chip 180 into Acerola. Do not Nest Tangela.
- Skip Hop when the deck has ≤10 cards.

## 3,000 games (seed `20260819`)
