...
This bakeoff left the list unlocked. The later cut matrix locked **1 Prankish + 1 CLC + 1 Pad** by cutting the second Mega — [set-c60-pad-clc-cuts.md](set-c60-pad-clc-cuts.md).
